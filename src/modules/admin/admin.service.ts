  ...
  async listVehicleCapacities() {
    ...
    return {
      vehicleCapacities: capacities.map((c) => ({
        ...
        rateReductionPer100Miles: c.rateReductionPer100Miles ? Number(c.rateReductionPer100Miles) : null,
  ...
  async updateVehicleCapacity(vehicleType: VehicleType, dto: UpdateVehicleCapacityDto) {
    ...
    const updated = await this.prisma.vehicleCapacity.update({
      ...
      data: {
        ...
        rateReductionPer100Miles: dto.rateReductionPer100Miles,
    ...
    return {
      ...
      rateReductionPer100Miles: updated.rateReductionPer100Miles ? Number(updated.rateReductionPer100Miles) : null,
